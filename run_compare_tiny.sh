...
run_model "1/4" "trm_tiny"
run_model "2/4" "iect_tiny"
run_model "3/4" "iect_tiny_v2"
# run_model "4/5" "trm_mor_small"  # Disabled due to gradient issue
run_model "4/4" "fiect_tiny"
